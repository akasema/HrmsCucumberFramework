...
public class CommonMethods extends PageInitializer {
	...
	/**
	 * This method will select from dropdown menu
	 * @param element
	 * @param visibleText
	 */
	...
	for (WebElement option:options) {
		...
		if(!isFound) {
			System.out.println("Value "+"was not found inn dropdown");
		}		
	}
	/**
	 * This method will select from dropdown menu
	...
	public static void selectDdValue(WebElement element, int index){
		...
		if(!isFound) {
			System.out.println("Value with index "+index+"was not found inn dropdown");
		}	
	}
	
	/**
	 * This method will click on radio based on text
	 * @param elements
	 * @param radioText
	 */
